...
static byte xiadm02_blocks [] = {
    ...
    next_event & 255), 0, 3, 0, 0, 0, 0, 0, 'n', 'e', 'x', 't', 0, '/',
    'a', 'd', 'm', 'i', 'n', '/', '$', 'n', 'e', 'x', 't', '.', 'g',
    'i', 'f', 0,
    ...
    /*  <BR>                                                                 */
    0, 6, 0, '<', 'B', 'R', '>', 10,
    /*  !--ACTION defaults  LABEL="D ... T=default_event TYPE=BUTTON         */
    0, 32, 20, 0, (byte) ((word) default_event / 256), (byte) ((word)
    ...
    basehost_event & 255), 0, 9, 0, 0, 0, 0, 0, 'b', 'a', 's', 'e', 'h',
...
static FIELD_DEFN xiadm02_fields [] = {
    ...
    { 82, 1174, 5 },                    /*  l_filename                      */
    { 89, 1244, 14 },                   /*  l_filedate                      */
    { 105, 1284, 12 },                  /*  l_filesize                      */
    { 119, 1372, 80 },                  /*  filename                        */
    { 939, 1401, 8 },                   /*  filedate                        */
    { 1039, 1430, 5 },                  /*  filetime                        */
    { 1109, 1456, 5 },                  /*  filesize                        */
    { 1179, 1633, 4 },                  /*  config_list                     */
    { 1185, 0, 0 },                     /*  -- sentinel --                  */
    };
