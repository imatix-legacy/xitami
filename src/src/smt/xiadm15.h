...
static byte xiadm15_blocks [] = {
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f270 NAME=L_wsx-alias VALUE="URL alias:"            */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '2', '7', '0', 0, 'U', 'R',
    'L', 32, 'a', 'l', 'i', 'a', 's', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 4, 218,
    /*  !--FIELD TEXTUAL f271 NAME=L ... ent VALUE="WSX agent name:"         */
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '2', '7', '1', 0, 'W', 'S',
    'X', 32, 'a', 'g', 'e', 'n', 't', 32, 'n', 'a', 'm', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 5, 20,
    /*  !--REPEAT wsx_list  ROWS=10                                          */
    0, 7, 4, 0, 6, 0, 12, 0, 10,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f272 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 10, 0, 0, 20, 0, 20, 'f', '2', '7', '2', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, '`',
    /*  !--FIELD TEXTUAL f273 NAME=w ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 10, 0, 0, 20, 0, 20, 'f', '2', '7', '3', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 144,
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, '`',
    /*  !--FIELD TEXTUAL f274 NAME=w ... E=40 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 10, 0, 0, '(', 0, '(', 'f', '2', '7', '4', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 144,
    /*  </TR>                                                                */
    0, 4, 1, 0, 5, 'Q',
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 3, 249,
    /*  !--FIELD NUMERIC wsx_list SIZE=4 VALUE=10                            */
...
static FIELD_DEFN xiadm15_fields [] = {
    { 0, 1115, 80 },                    /*  message_to_user                 */
    { 82, 1274, 10 },                   /*  l_wsx_alias                     */
    { 94, 1315, 15 },                   /*  l_wsx_agent                     */
    { 111, 1408, 20 },                  /*  key                             */
    { 331, 1439, 20 },                  /*  wsx_alias                       */
    { 551, 1467, 40 },                  /*  wsx_agent                       */
    { 971, 1501, 4 },                   /*  wsx_list                        */
    { 977, 0, 0 },                      /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    char   key                  [10] [20 + 1];
    byte   wsx_alias_a          [10] ;
    char   wsx_alias            [10] [20 + 1];
    byte   wsx_agent_a          [10] ;
    char   wsx_agent            [10] [40 + 1];
    byte   wsx_list_a           ;
    char   wsx_list             [4 + 1];
    byte   back_a;
    byte   save_a;
