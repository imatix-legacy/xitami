...
static byte xiadm14_blocks [] = {
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f265 NAME=L ... ias-name VALUE="CGI alias:"         */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '2', '6', '5', 0, 'C', 'G',
    'I', 32, 'a', 'l', 'i', 'a', 's', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 4, 196,
    /*  !--FIELD TEXTUAL f266 NAME=L ... ath VALUE="Points to path:"         */
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '2', '6', '6', 0, 'P', 'o',
    'i', 'n', 't', 's', 32, 't', 'o', 32, 'p', 'a', 't', 'h', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 4, 254,
    /*  !--REPEAT cgi_alias_list  ROWS=10                                    */
    0, 7, 4, 0, 6, 0, 12, 0, 10,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f267 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 10, 0, 0, 20, 0, 20, 'f', '2', '6', '7', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, 'J',
    /*  !--FIELD TEXTUAL f268 NAME=c ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 10, 0, 0, 20, 0, 20, 'f', '2', '6', '8', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 'z',
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, 'J',
    /*  !--FIELD TEXTUAL f269 NAME=c ... =50 MAX=80 UPPER=0 VALUE=""         */
    0, 14, 10, 0, 10, 0, 0, '2', 0, 'P', 'f', '2', '6', '9', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 'z',
    /*  </TR>                                                                */
    0, 4, 1, 0, 5, ';',
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 3, 227,
    /*  !--FIELD NUMERIC cgi_alias_list SIZE=4 VALUE=10                      */
...
static FIELD_DEFN xiadm14_fields [] = {
    ...
    { 82, 1252, 10 },                   /*  l_cgi_alias_name                */
    { 94, 1293, 15 },                   /*  l_cgi_alias_path                */
    { 111, 1386, 20 },                  /*  key                             */
    { 331, 1417, 20 },                  /*  cgi_alias_name                  */
    { 551, 1445, 80 },                  /*  cgi_alias_path                  */
    { 1371, 1479, 4 },                  /*  cgi_alias_list                  */
    { 1377, 0, 0 },                     /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    byte   key_a                [10] ;
    char   key                  [10] [20 + 1];
    byte   cgi_alias_name_a     [10] ;
    char   cgi_alias_name       [10] [20 + 1];
    byte   cgi_alias_path_a     [10] ;
    char   cgi_alias_path       [10] [80 + 1];
