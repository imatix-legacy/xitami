...
static byte xiadm13_blocks [] = {
    ...
    /*  <TD ALIGN=CENTER><FONT SIZE= ... ource Authentication </FONT>        */
    0, 76, 0, '<', 'T', 'D', 32, 'A', 'L', 'I', 'G', 'N', '=', 'C', 'E',
    'N', 'T', 'E', 'R', '>', '<', 'F', 'O', 'N', 'T', 32, 'S', 'I', 'Z',
    'E', '=', '+', '1', '>', '#', '(', 'c', 'o', 'n', 'f', 'i', 'g',
    ')', 32, 45, 32, 'R', 'e', 's', 'o', 'u', 'r', 'c', 'e', 32, 'A',
    'u', 't', 'h', 'e', 'n', 't', 'i', 'c', 'a', 't', 'i', 'o', 'n', 32,
    '<', '/', 'F', 'O', 'N', 'T', '>', 10,
    /*  <TD ALIGN=RIGHT>                                                     */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f262 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 10, 0, 0, 20, 0, 20, 'f', '2', '6', '2', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, 'P',
    /*  !--FIELD TEXTUAL f263 NAME=u ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 10, 0, 0, 20, 0, 20, 'f', '2', '6', '3', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 128,
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, 'P',
    /*  !--FIELD TEXTUAL f264 NAME=p ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 10, 0, 0, 20, 0, 20, 'f', '2', '6', '4', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 128,
    /*  </TR>                                                                */
    0, 4, 1, 0, 5, 'A',
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 3, 239,
    /*  !--FIELD NUMERIC user_list SIZE=4 VALUE=10                           */
...
static FIELD_DEFN xiadm13_fields [] = {
    { 0, 1105, 80 },                    /*  message_to_user                 */
    { 82, 1264, 10 },                   /*  l_user_name                     */
    { 94, 1305, 9 },                    /*  l_password                      */
    { 105, 1392, 20 },                  /*  key                             */
    { 325, 1423, 20 },                  /*  user_name                       */
    { 545, 1451, 20 },                  /*  password                        */
    { 765, 1485, 4 },                   /*  user_list                       */
    { 771, 0, 0 },                      /*  -- sentinel --                  */
    };
