...
static byte xiadm24_blocks [] = {
    ...
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f396 NAME=L_type VALUE="Type:"                      */
    0, 19, 10, 6, 1, 0, 0, 5, 0, 5, 'f', '3', '9', '6', 0, 'T', 'y',
    'p', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 4, 's',
    /*  !--FIELD TEXTUAL f397 NAME=L ...  VALUE="Client IP address:"         */
    0, 32, 10, 6, 1, 0, 0, 18, 0, 18, 'f', '3', '9', '7', 0, 'C', 'l',
    ...
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 4, 's',
    /*  !--FIELD TEXTUAL f398 NAME=L_username VALUE="User name:"             */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '3', '9', '8', 0, 'U', 's',
    'e', 'r', 32, 'n', 'a', 'm', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 4, 168,
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f399 NAME=type SIZE=4 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 0, 16, 0, 0, 4, 0, 4, 'f', '3', '9', '9', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, 29,
    /*  !--FIELD TEXTUAL f400 NAME=i ... E=15 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 16, 0, 0, 15, 0, 15, 'f', '4', '0', '0', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 'M',
    /*  <TD ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 5, 29,
    /*  !--FIELD TEXTUAL f401 NAME=u ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 16, 0, 0, 20, 0, 20, 'f', '4', '0', '1', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 5, 'M',
    /*  </TR>                                                                */
    0, 4, 1, 0, 5, 14,
...
static FIELD_DEFN xiadm24_fields [] = {
    { 0, 962, 80 },                     /*  message_to_user                 */
    { 82, 1025, 4 },                    /*  refresh_on                      */
    { 88, 1171, 5 },                    /*  l_type                          */
    { 95, 1207, 18 },                   /*  l_ipaddress                     */
    { 115, 1253, 10 },                  /*  l_username                      */
    { 127, 1341, 4 },                   /*  type                            */
    { 223, 1372, 15 },                  /*  ipaddress                       */
    { 495, 1400, 20 },                  /*  username                        */
    { 847, 1434, 4 },                   /*  client_list                     */
    { 853, 0, 0 },                      /*  -- sentinel --                  */
    };
