...
:-  compile testcgi  testdir  teststr  testxml  testtron
call c testcgi
...
:-  link    testcgi  testdir  teststr  testxml  testtron
call c -L testcgi
call c -L testdir
call c -L teststr
call c -L testxml
