/*  ----------------------------------------------------------------<Prolog>-
    ...
    Version:    2.01
    <TABLE>
    2.01_PH     Released with SFL 2.01
    </TABLE>
...
#elif (defined (__DJGPP__))             /*  DJGPP supports timezone - rj     */
#   undef TIMEZONE                      /*  I don't. I'll fix this later     */
#   define TIMEZONE 0                   /*  when I work out what's required  */
